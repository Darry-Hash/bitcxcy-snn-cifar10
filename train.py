...
"""
import torch
from model import MLP  # 假设你的模型类定义在model.py中，并且类名为MLP

# 实例化模型
model_instance = MLP(in_features=784, hidden_features=128, out_features=10)  # 根据你的模型参数进行调整
...
if __name__ == '__main__':
    torch.save(model_instance.state_dict(), 'save.pth')
    print("模型已训练并保存")
    main()
